...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='')
    parser.add_argument('--det_player', required=True,
                        metavar="/path/to/balloon/dataset/",
                        help='Path to detections file of the team')
    parser.add_argument('--det_ball', required=True,
                        metavar="/path/to/balloon/dataset/",
                        help='Path to track of the ball')
    parser.add_argument('--video', required=True,
                        metavar="path or URL to video",
                        help='Video to apply the tracking on')
    parser.add_argument('--out_stats', required=False,
    ...
    print("Players Detections: ", args.det_player)
    print("Ball tracking path: ", args.det_ball)
    print("out: ", args.out_stats)

    stats(args.video, args.det_ball, args.det_teams, args.out_stats)